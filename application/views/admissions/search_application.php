...
<div class="page-title">
	...
	<ul class="breadcrumb">
		...
		<li class="">Search Application</li>
	</ul>
</div>	<!-- /heading -->
...
<div class="container-fluid">
	<?php
		...
		echo form_open('admissions/searchapplication/SEARCH', $form);
	?>
				...
				<table class="wrl-table btm-mrgn-xs">
					<thead>
						<tr>
							...
							<th style="width:6%;">UG</th>
							<th style="width:6%;">Written</th>
					...
					<tbody id="tbl-content">
						...
						?>
							<tr>
								...
								<td><?php echo $info['RESULT'][$i]['pg_appl_grad_pct'];?></td>
								<td><?php echo $info['RESULT'][$i]['pg_appl_written_score'];?></td>
