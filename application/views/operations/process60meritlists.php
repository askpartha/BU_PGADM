<div class="page-title">
	<h2>Process/Revoke Rank List - 60% Category</h2>
	<ul class="breadcrumb">
		<li>You are here:</li>
		<li class="active">Operation</li>
		<li class="">Process Rank Lists - 60% Category</li>
	</ul>
</div>	<!-- /heading -->
			...
			<div class="box">
				...
				<div class="content">	
					<?php
						...
						echo form_open('operations/revoke60merits', $form);
					?>
			...
			<div class="box">
				...
				<div class="content">	
					<?php
						...
						echo form_open('operations/process60merits', $form);
					?>
						<div class="form-group">
							<label>Subjects</label>
							<?php
