		...
		<div class="container-fluid">
	        <div class="row">
	        	<div class="col-lg-12 col-sm-12 top-mrg-lg btm-mrg-lg" style="text-align:center;margin-top:100px;height:400px;">
					<h1 class="red-text">We are down now for  maintenance.</h1>
					<!-- 
					<h4>Applications will be down from 11:00 PM  to 3:45 AM Indian local time. <br/> Do NOT attempt to submit an application between these times.</h4>
					-->
				</div>
			</div>
		</div>	
